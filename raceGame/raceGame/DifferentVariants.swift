...
//    }
//
//    // сделали дороги по которым будут падать препятствия
...
//        let widthObstacle = (screenWidght - 80) / 3
//        let heightObstacle = widthObstacle * 0.8
//        let checkCarDamage = self.carImage.frame.minY - self.obstacleImage.frame.height + 11
//        makeRandomObstacles()
...
//                self.view.layoutIfNeeded()
//            } completion: { _ in
//                if Int(self.carImage.frame.midX) == Int(self.obstacleImage.frame.midX) &&
//                    Int(self.carImage.frame.minY) == Int(self.obstacleImage.frame.maxY - 11) {
//                    print("DAMAGE")
//                } else {
...
//        let heightObstacle = widthObstacle * 0.8
//        let checkCarDamage = self.carImage.frame.minY - self.obstacleImage.frame.height + 11
//        self.startCheking(self.obstacleImage.frame.midX)
//        UIView.animate(withDuration: 0, delay: 0, options: .curveLinear) {
//            self.obstacleImage.frame = CGRect(x: cordinatesX,
//                                              y: checkCarDamage,
//                                              width: widthObstacle,
...
//    }
//
//    func startCheking(_ obstaclePosition: CGFloat) {
//
//        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) { [weak self] in
//            print(obstaclePosition, self?.carImage.frame.midX)
//            if obstaclePosition == self?.carImage.frame.midX {
//                print("DAMAGE")
//                self?.paused = true
//                if self?.paused == true {
//                    return
//                }
//            } else {
//                self?.startCheking(obstaclePosition)
//            }
//
//        }
//    }
